...
REVOKE ALL ON FUNCTION public.admin_reset_donnees_metier() FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.admin_reset_donnees_metier() TO authenticated;